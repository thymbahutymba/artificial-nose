...
#define IMAGE_Y1 (EXTERNAL_MARGIN)
...
#define IMG_YT (IMAGE_Y1 + INTERNAL_MARGIN) // y starting point for image
...
#define GRAPH_WIDTH (SCREEN_WIDTH - EXTERNAL_MARGIN * 2)
#define GRAPH_HEIGHT (SCREEN_HEIGHT - IMAGE_HEIGHT - EXTERNAL_MARGIN * 3)

// Coordinates for the drawing the rectangle that delimits graphs section
#define GRAPH_X1 (EXTERNAL_MARGIN)
#define GRAPH_Y1 (IMAGE_Y2 + EXTERNAL_MARGIN)
#define GRAPH_X2 (SCREEN_WIDTH - EXTERNAL_MARGIN)
#define GRAPH_Y2 (SCREEN_HEIGHT - EXTERNAL_MARGIN)
...
#define LEGEND_X1 (EXTERNAL_MARGIN)
#define LEGEND_Y1 (EXTERNAL_MARGIN)
#define LEGEND_X2 (IMAGE_X2 - EXTERNAL_MARGIN)
#define LEGEND_Y2 (80)
...
#define INPUT_Y1 (LEGEND_Y2 + EXTERNAL_MARGIN)
#define INPUT_X2 (IMAGE_X2 - EXTERNAL_MARGIN)
#define INPUT_Y2 (INPUT_Y1 + INPUT_H)

#define TEXT_X1 (INPUT_X1 + INTERNAL_MARGIN)
#define TEXT_Y1 (INPUT_Y1 + LINE_SPACE)
...
#define SUBBOX_Y1 (IMAGE_Y2 - G_SUBBOX)
#define SUBBOX_X2 (IMAGE_X2 - EXTERNAL_MARGIN)
#define SUBBOX_Y2 (SUBBOX_Y1 + G_SUBBOX)

#define SXT_S (SUBBOX_X1 + INTERNAL_MARGIN)   // x position of static text
#define SYT_SCURRENT (SUBBOX_Y1 + LINE_SPACE) // text row for current
...
#define RESULT_X2 (IMAGE_X2 - EXTERNAL_MARGIN)
#define RESULT_Y2 (SUBBOX_Y1 - EXTERNAL_MARGIN) // GRAPH_Y2-EXTERNAL_MARGIN
