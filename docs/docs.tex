...
smells of coffee and orange. This two smells was chosen due to their limited
CO2 and tVOC values. However, in our opinion, the sensor used for the
application is not able to discriminate between this two smells. Hence the
neural network can't produce the hoped results using the images created
starting from both values: CO2 and tVOC.
